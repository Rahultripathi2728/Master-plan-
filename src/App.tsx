          ...
          <div className="relative mb-8 flex flex-col items-center">
            ...
            <div className="md:absolute md:right-0 md:top-0 flex gap-3 no-print items-center mt-4 md:mt-0">
              ...
              <button 
                ...
                className="bg-[#141414] text-white p-3 rounded-2xl hover:bg-black transition-all shadow-lg flex items-center gap-2 text-xs font-bold uppercase tracking-widest"
              >
